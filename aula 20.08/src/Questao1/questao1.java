...
public class questao1  {
	...
	private void initialize() throws ParseException {
		...
		tabbedPane.addTab("Dados Pessoais", new ImageIcon(questao1.class.getResource("/icons/registo-medico.png")), panel_dados, null);
		...
		tabbedPane.addTab("Anamnese", new ImageIcon(questao1.class.getResource("/icons/anamnese.png")), panel_anmnese, null);
		...
		tabbedPane.addTab("Exames ", new ImageIcon(questao1.class.getResource("/icons/registros-medicos.png")), panel_exames, null);
		...
		tabbedPane.addTab(" Tratamento", new ImageIcon(questao1.class.getResource("/icons/medico.png")), panel_tratamento, null);
		...
		mntmNewMenuItem.setIcon(new ImageIcon(questao1.class.getResource("/icons/ok1.png")));
		mnMenu.add(mntmNewMenuItem);
		mnMenuItem.setIcon(new ImageIcon(questao1.class.getResource("/icons/clean.png")));
